...
def _scan_file(msg_file) -> dict:
    """Return scan result for a single uploaded file."""
...
def upload(request: HttpRequest) -> HttpResponse:
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            files = request.FILES.getlist('msg_file')
...
def upload_ajax(request: HttpRequest) -> JsonResponse:
    if request.method != 'POST':
